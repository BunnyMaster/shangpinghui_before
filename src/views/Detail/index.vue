      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          <div class="goodsDetail">
            <h3 class="InfoName">{{ skuInfoList.skuName }}</h3>
            ...
            <div class="priceArea">
              ...
              <div class="priceArea2">
                ...
                <div class="fixWidth">
                  ...
                  <em class="t-gray">{{ skuInfoList.skuDesc }}</em>
                </div>
              </div>
            </div>
            <div class="support">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSale,index) in GoodInfo.spuSaleAttrList" :key="spuSale.id">
                ...
                <dd changepirce="0"
                    ...
                    :key="spuSaleAttr.id"
                    @click="saleAttrValue(spuSaleAttr,spuSale.spuSaleAttrValueList)"
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" type="text" class="itxt" v-model="skuNum" @change="skuNumChange">
...
export default {
  ...
  setup() {
    ...
    const Str = reactive({
      GoodInfo: computed(() => detail.state.GoodInfo) || {price: undefined,},
      CategoryList: computed(() => detail.state.categoryView),
      skuInfoList: computed(() => detail.state.skuInfo) || {
        skuName: "服务器未返回正确的数据,所以载入失败",
        isSale: undefined,
        skuDesc: undefined,
      },
      skuNum: 1,
    ...
    const Fun = reactive({
      //点击售卖的属性
      saleAttrValue(spuSaleAttr, spuSaleAttrValue) {
        spuSaleAttrValue.forEach(item => item.isChecked = "0");
  ...
  mounted() {
    const UseRouter = useRouter();
    const UseRoute = useRoute();
    detail.dispatch("getGoodInfo", UseRoute.params.skuid);
  }
}
</script>
